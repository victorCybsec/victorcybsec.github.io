...
Navigating to the web page on port 80, we find **HP Power Manager**.
...
- Added extra time (from 30 to 60 seconds as recommended in the final comment of the script)
- Some minor python syntax changes (prints and our recently generated payload)
